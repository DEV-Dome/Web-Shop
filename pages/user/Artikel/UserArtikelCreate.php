...
?>
<script src="acp/js/pages/add/ArtikelAdd.js"></script>
<style>
    .input-field label {
        color: #000;
    }
...
<div style="padding-left: 1vw; padding-top: 2vh;" class=" row">
    ...
    if($id != null){
        ...
        <p>(Jeder Artikel braucht ein Bild, um in der Suche gelistet zu werden)</p>
        <?php
    }else {
        ?>
        <div class="col s12 m4 l8"><p><button class="btn waves-effect waves-light" onclick="requstformulaUser(document.getElementById('name'),document.getElementById('beschreibung'), document.getElementById('preis'),document.getElementById('bestand'),<?php echo $_SESSION['id'];?> );">Senden<i class="material-icons right">arrow_forward</i></p></button></div>
        <p>(Jeder Artikel braucht ein Bild, um in der Suche gelistet zu werden)</p>
        <?php
    }
    ?>
